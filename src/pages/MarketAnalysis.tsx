...
export default function MarketAnalysisPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0f18] text-white font-sans overflow-x-hidden relative flex flex-col">
      ...
      {/* --- MAIN CHART & CONTENT --- */}
      {!selectedCoin && coins.length === 0 && !isLoading ? (
        <div className="max-w-7xl mx-auto w-full px-4 md:px-8 pb-12 relative z-10">
          <div className="text-center py-20">
            <div className="w-16 h-16 rounded-full bg-[#14F195]/5 border border-[#14F195]/10 flex items-center justify-center mx-auto mb-4">
              <ChartLineUp size={28} weight="duotone" className="text-[#14F195]/50" />
            </div>
            <p className="text-neutral-400 text-sm mb-2">Unable to fetch market data</p>
            <p className="text-neutral-600 text-xs mb-4">CoinGecko API may be rate-limited. Please try again.</p>
            <button 
              onClick={() => window.location.reload()}
              className="px-5 py-2 rounded-xl bg-[#14F195]/10 text-[#14F195] text-sm font-semibold hover:bg-[#14F195]/20 transition-colors"
            >
              Refresh Page
            </button>
          </div>
